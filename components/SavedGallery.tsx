              ...
              <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center flex-wrap gap-2 p-2">
                {airtableConfigured && (
                  <button 
                    ...
                    disabled={isSaving}
                    className="bg-blue-600 text-white p-2 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-blue-900 disabled:cursor-not-allowed"
                    aria-label="Save to Airtable" title="Save to Airtable">
                    {isSaving ? (
                ...
                <button onClick={() => onDeleteImage(image.id)} className="bg-red-600 text-white p-2 rounded-full hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500" aria-label="Delete image" title="Delete Image">
